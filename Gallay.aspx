<%@ Page Title="" Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" CodeFile="Gallay.aspx.cs" Inherits="Gallay" %>
...
<script type="text/javascript" src="Aimg/lightbox.js"></script>
    <table class="tbl">
        ...
        <tr>
            <td style="border-bottom-style: solid; border-bottom-width: medium; border-bottom-color: #808080">
                &nbsp;</td>
        </tr>
        <tr>
            <td>
