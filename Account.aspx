<%@ Page Title="" Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" CodeFile="Account.aspx.cs" Inherits="Account" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtfname" runat="server" BorderColor="#6600CC" 
                                        BorderStyle="Groove" BorderWidth="1px"></asp:TextBox>
                                </td>
                                <td class="lbl">
                                    City :
                                </td>
                            ...
                            <tr>
                                <td colspan="4" style="color: Green">
                                    ...
                                    <asp:TextBox ID="txtabout" runat="server" BorderColor="#6600CC" 
                                        BorderStyle="Groove" BorderWidth="1px" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                    &nbsp;
