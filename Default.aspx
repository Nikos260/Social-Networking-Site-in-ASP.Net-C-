...
<body>
    ...
    <div id="left" class="style5">
        ...
        <br />
        <br />
        <strong><span class="style6">www.meeraacademy.com</span></strong></div><div id="right">
        <table class="style2">
            <tr>
                <td class="style3">
                    &nbsp;</td>
            ...
            <tr>
                <td colspan="3" 
                    ...
                    style="font-weight: 700; text-align: center; font-size: xx-large; font-family: 'Arial Unicode MS'; color: #FF6600">
                    Create New Account - Free !!</td>
            </tr>
            <tr>
                <td class="style3">
                    &nbsp;</td>
            ...
            <tr>
                <td class="style3">
                    &nbsp;</td>
                <td>
                    <asp:TextBox ID="txtemail" runat="server" placeholder="Email" CssClass="txtreg" 
                       ></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="color: #FF6600; font-size: 12pt">
                    Birth Date :</td>
            </tr>
            <tr>
                <td class="style3">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtpswd2" runat="server" placeholder="Conf-Pass" 
                        CssClass="txtreg" ontextchanged="txtpswd2_TextChanged" TextMode="Password"></asp:TextBox>
                </td>
                <td>
