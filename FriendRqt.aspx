<%@ Page Title="" Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" CodeFile="FriendRqt.aspx.cs" Inherits="FriendRqt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        <tr>
            <td class="tblhead">
                My Request(<asp:Label ID="lblrqt" runat="server"></asp:Label>
                )</td>
        </tr>
        <tr>
            <td>
                    ...
                    <ItemTemplate>
                        <table class="style21">
                            <tr>
                                ...
                                <td class="style22">
                                    <asp:Label ID="lblname" runat="server" Text='<%#Eval("Fname") %>'></asp:Label>   <asp:Label ID="Label1" runat="server" Text='<%#Eval("lname") %>'></asp:Label>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
