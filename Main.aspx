<%@ Page Title="" Language="C#" MasterPageFile="login.master" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Main" %>
            ...
            <td>
                ...
                <asp:TextBox ID="txtpost" runat="server" Height="60px" TextMode="MultiLine" 
                    Width="470px" BorderColor="#00CC66" BorderStyle="Solid" BorderWidth="1px" 
                                BackColor="#FBFBFB" ontextchanged="txtpost_TextChanged"></asp:TextBox>
                        </td>
                        <td valign="bottom">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    <asp:LinkButton ID="LinkButton3" CommandName="like" 
                                        CommandArgument='<%#Eval("pid") %>' runat="server"  Text='Like'></asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton1" CommandName="like" 
                                        CommandArgument='<%#Eval("pid") %>' runat="server"  Text='<%#Eval("like") %>'></asp:LinkButton>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
