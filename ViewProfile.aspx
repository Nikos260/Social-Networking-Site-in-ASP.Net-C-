<%@ Page Title="" Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" CodeFile="ViewProfile.aspx.cs" Inherits="ViewProfile" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox3" runat="server" Height="50px" TextMode="MultiLine" 
                                            Width="200px" ontextchanged="TextBox3_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
